...
for FILE in "$DATA_DIRECTORY"/*.fq.gz; do
    # Extract the base name of the file for naming the output folder
    BASENAME=$(basename "$FILE" _R1_001.fq.gz)
...
#```{bash}
find /home/shared/8TB_HDD_02/graceac9/data/pycno2022 \
| xargs -n 1 basename -s _R1_001.fastq.gz.fastp-trim.20231101.fq.gz \
| xargs -I{} /home/shared/kallisto/kallisto quant \
  ...
  -o /home/shared/8TB_HDD_02/graceac9/GitHub/project-pycno-sizeclass-2022/analyses/07-kallisto-phelgenome/{}_output \
  -t 20 \
  /home/shared/8TB_HDD_01/apul/trimmed/{}_R1_001.fastq.gz.fastp-trim.20231101.fq.gz \
  /home/shared/8TB_HDD_01/apul/trimmed/{}_R2_001.fastq.gz.fastp-trim.20231101.fq.gz \
2>&1 | tee ../analyses/07-kallisto-phelgenome/{}.out
```
