...
NMDS with adonis→ have the grouping be first arm drop, 
Test whether day interacts with time of disease 
An ANOVA you can do with an NMDS 
How does individual treatment and date interact with disease sign 
...
Treatment in this case is whether the star is an adult or juvenile...? 
